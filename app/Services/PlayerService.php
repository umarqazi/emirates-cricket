...
class PlayerService
{
    ...
    public function all()
    {
        return $this->player_repo->all();
    }

    public function find($id)
    {
        return $this->player_repo->find($id);
    }

    public function findOne($id)
    {
        return $this->player_repo->findOne($id);
    }
    ...
    public function store($params)
    {
        ...
        $player = $this->player_repo->store($params);
        if (!empty($player)) {
            ...
            $this->player_repo->update($data, $player->id);
            return $player;
        }
    }
    ...
    public function update($params, $id)
    {
        ...
        return $this->player_repo->update($data, $id);
    }

    public function delete($id)
    {
        $name = $this->player_repo->find($id)->photo;
        $result = $this->player_repo->destroy($id);
        if ($result) {
    ...
    {
        $this->player_repo->update(array('status' => Player::$Approved), $id);
        return true;
    }

    public function declineRequest($id): bool
    {
        $this->player_repo->update(array('status' => Player::$Declined), $id);
        return true;
    }

                                                ...
                                                <table id="page-length-option" class="display">
                                                    ...
                                                    @if(!empty($socialAccount->posts))
                                                        @foreach($socialAccount->posts as $post)
                                                            ...
                                                            @endphp
                                                            <tr>
                                                                <td>{{ !empty($data->caption) ? \Illuminate\Support\Str::limit($data->caption, 50) : 'No Captain'}}</td>
                                                                <td>{{$data->media_type}}</td>
                                                                <td>
                                                                    <a href="{{$data->permalink}}" target="_blank"><i class="material-icons">visibility</i></a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    @else
                                                        <tr>
                                                            <td colspan="3" class="center">No Instagram Posts Available...</td>
                                                        </tr>
                                                    @endif
                                                    </tbody>
                                                    <tfoot>

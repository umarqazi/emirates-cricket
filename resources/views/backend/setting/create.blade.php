...
@section('title')
    <title>Create Setting| Admin Panel</title>
@endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0">Create Setting</h5>
                </div>
                <div class="col s12 m6 l6 right-align-md">
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Create Setting
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col s12 m12 l12">
                        <div id="Form-advance" class="card card card-default scrollspy">
                            <div class="card-content">
                                ...
                                <form class="col s12" method="POST" action="{{route('setting.store')}}">
                                    @csrf

                                    <div class="row">
                                        <div class="input-field col m12 s12">
                                            <input id="title" type="text" name="tournament_fees" class="validate @error('tournament_fees') invalid @enderror" value="{{old('tournament_fees')}}" placeholder="Type Tournament Fees Here...">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <button class="btn cyan waves-effect waves-light right" type="submit">Create Settings
...
@section('scripts')
    ...
    <script>
        var path = "{{public_path('storage/uploads/temp/homepage-slider-images/')}}"

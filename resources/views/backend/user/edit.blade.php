        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0">Update User</h5>
                </div>
                <div class="col s12 m6 l6 right-align-md">
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{route('player.index')}}">User List</a>
                        </li>
                                    ...
                                    <form class="col s12" method="POST" action="{{route('user.update', $user->id)}}">
                                        ...
                                        <div class="row">
                                            <div class="input-field col m12 s12">
                                                <input id="title" type="text" name="name" class="validate @error('name') invalid @enderror" value="{{$user->name}}">
                                        ...
                                        <div class="row">
                                            <div class="input-field col m12 s12">
                                                <input id="title" type="email" name="email" class="validate @error('email') invalid @enderror" value="{{$user->email}}">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <button class="btn cyan waves-effect waves-light right" type="submit">Update User

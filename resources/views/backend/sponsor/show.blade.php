...
@section('title')
    <title>Show Sponsor Detail| Admin Panel</title>
@endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0">Sponsor Detail</h5>
                </div>
                <div class="col s12 m6 l6 right-align-md">
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Sponsor Detail
                        </li>
                    </ol>
                </div>
            </div>
                                ...
                                <form class="col s12">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m12 s12">
                                            <input id="title" type="text" name="title" class="validate" value="{{$sponsor->name}}">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m12 s12">
                                            <input id="title" type="text" name="title" class="validate" value="{{$sponsor->website}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12">
                                            <textarea id="message5" class="ckeditor" name="text" rows="15" placeholder="Type Sponsor Description in here...">{!! $sponsor->text !!}</textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>

...
<script src="{{URL::asset('backend/assets/js/chart.min.js')}}"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN THEME  JS-->
...
<!-- END THEME  JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{URL::asset('backend/assets/js/dashboard-ecommerce.min.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
</body>
</html>

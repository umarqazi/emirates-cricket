...
<head>
    ...
    <link rel="icon" href="{{ URL::asset('backend/assets/images/favicon-img.png') }}" sizes="16x16">
...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
    <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="{{route('dashboard')}}"><img src="{{URL::asset('backend/assets/images/logo.png')}} " alt="{{env('APP_NAME')}} Logo"/><span class="logo-text hide-on-med-and-down">ECB</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
    </div>
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="accordion">
        ...
        @if(auth()->user()->can('List About Pages'))
        ...
        @if(auth()->user()->can('List Development'))
        ...
        @if(auth()->user()->can('List Setting') || auth()->user()->can('Edit Setting'))

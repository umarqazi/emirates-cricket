                    ...
                    <div class="card-content">
                        <h4 class="header mt-0">
                            ...
                            <span class="purple-text small text-darken-1 ml-1">
                                            <i class="material-icons">keyboard_arrow_up</i> 15.58 %
                                        </span>
            ...
            <div class="col s12 m4">
                <div class="card animate fadeLeft">
                    <div class="card-content  center">
                        ...
                        <img src="{{URL::asset('backend/assets/images/cards/watch.png')}}" alt="" class="responsive-img" />
            ...
            <div class="col s12 m4">
                <div class="card animate fadeUp">
                    <div class="card-content">
                        ...
                        <img src="{{URL::asset('backend/assets/images/cards/headphones-2.png')}}" alt="" class="responsive-img" />
                    </div>
            ...
            <div class="col s12 m4">
                <div class="card animate fadeRight">
                    <div class="card-content center">
                        ...
                        <img src="{{URL::asset('backend/assets/images/cards/iphonec.png')}} " alt="" class="responsive-img" />
            ...
            <div class="row">
                <div class="col s12 m3">
                    <div class="card gradient-shadow gradient-45deg-light-blue-cyan border-radius-3 animate fadeUp">
                        <div class="card-content center">
                            <img src="{{URL::asset('backend/assets/images/icon/apple-watch.png')}}" class="width-40 border-round z-depth-5"
                ...
                <div class="col s12 m3">
                    <div class="card gradient-shadow gradient-45deg-red-pink border-radius-3 animate fadeUp">
                        <div class="card-content center">
                            <img src="{{URL::asset('backend/assets/images/icon/printer.png')}}" class="width-40 border-round z-depth-5" alt=""
                ...
                <div class="col s12 m3">
                    <div class="card gradient-shadow gradient-45deg-amber-amber border-radius-3 animate fadeUp">
                        <div class="card-content center">
                            <img src="{{URL::asset('backend/assets/images/icon/laptop.png')}}" class="width-40 border-round z-depth-5" alt=""
                                 class="responsive-img" />
                ...
                <div class="col s12 m3">
                    <div class="card gradient-shadow gradient-45deg-green-teal border-radius-3 animate fadeUp">
                        <div class="card-content center">
                            <img src="{{URL::asset('backend/assets/images/icon/bowling.png')}}" class="width-40 border-round z-depth-5" alt=""
                                 class="responsive-img" />

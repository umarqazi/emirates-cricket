                                ...
                                <form class="col s12">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m12 s12">
                                            <input id="title" type="text" name="name" class="validate" value="{{$role->name}}" disabled>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @for($i=0;$i<=3;$i++)
                                                            @if(!empty($permission[$i]))
                                                                <th width="20%">
                                                                    <label>
                                                                        <input type="checkbox" name="permission[]" class="filled-in" value="{{$permission[$i]['id']}}" {{!empty($rolePermissions) && in_array($permission[$i]['id'], $rolePermissions) ? 'checked' : ''}} disabled>
